...
export const unitSkillData: UnitSkillData = {
      ...
      effects: [{
        ...
        details: {
          self: {
            ...
            all_buff_removal_resist_up: { base: { milliPercentage: 15000 }, per_lv_up: { milliPercentage: 1000 }, term: 'infinite', cannot_be_dispelled: true }
          }
        }
      }, {
        conditions: [{ trigger: 'start_round' }],
  ...
  75: {
    ...
    active: [{
      ...
      effects: [{
        target: { kind: 'enemy' },
        details:{ target: { eva_down: { base: { milliPercentage: 30000 }, per_lv_up: { milliPercentage: 1500 }, term: { for_rounds: 3 }, max_stack: 1 } } }
      }, {
        conditions: [{ trigger: 'hit' }],
        target: { kind: 'enemy' },
        details:{ target: { ap_down: { base: { microValue: 300000 }, per_lv_up: { microValue: 15000 }, term: 'immediate' } } }
      }, {
        conditions: [{ trigger: 'hit', state: { target: [{ affected: 'marked' }, { affected: 'immovable' }] } }],
        target: { kind: 'enemy' },
    ...
    passive: [{
      ...
      effects: [{
        ...
        details: { self: { cri_up: { base: { milliPercentage: 10000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 1 } } } }
      }, {
        conditions: [{ trigger: 'start_round', state: { squad: { num_of_units: { unit: 'ally', equal: 4 } } } }],
        details: { self: { spd_up: { base: { milliPercentage: 10000 }, per_lv_up: { milliPercentage: 500 }, term: { for_rounds: 1 } } } }
      }]
    }, {
      area: 'fixed_all',
      effects: [{
        conditions: [{ trigger: 'start_round' }],
        details: { self: { electric_resist_up: { base: { milliPercentage: 40000 }, per_lv_up: { milliPercentage: 5000 }, term: { for_rounds: 1 } } } }
      }, {
        conditions: [{ trigger: 'start_round', state: { target: [{ affected: 'electric_resist_up' }] } }],
        target: { kind: 'ally' },
        details: {
          target: {
            atk_up: { base: { milliPercentage: 10000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 1 } },
      ...
      effects: [{
        ...
        details: {
          target: {
            electric_resist_down: { base: { milliPercentage: 15000 }, per_lv_up: { milliPercentage: 1500 }, term: { for_rounds: 1 } },
            eva_down: { base: { milliPercentage: 10000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 1 } },
            acc_down: { base: { milliPercentage: 10000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 1 } }
          }
        }
        ...
        target: { kind: 'enemy' },
        details: { target: { fixed_damage: { base: { milliPercentage: 100000 }, per_lv_up: { milliPercentage: 10000 }, term: 'immediate' } } }
      }]
    }]
  },
  76: {
  ...
  97: {
    ...
    active: [{
      damage_deal: {
        base: { milliPercentage: 99900 },
        per_lv_up: { milliPercentage: 9900 }
      },
      range: 4,
      cost: 5,
      area: 'single',
      effects: [{
        conditions: [{ trigger: 'hit' }],
        target: { kind: 'enemy' },
        details: { target: { def_down: { base: { milliPercentage: 20000 }, per_lv_up: { milliPercentage: 2500 }, term: { for_rounds: 2 } } } }
      }, {
        conditions: [
          { trigger: 'hit', state: { self: [{ tagged: 'cousette' }] } },
          { trigger: 'hit', state: { squad: { in_squad: { unit: 106, tagged: 'guiding_technique' } } } }
        ],
        target: { kind: 'enemy' },
        details: { target: { status_resist_down: { base: { milliPercentage: 20000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 2 } } } }
      }, {
        conditions: [
          { trigger: 'hit', state: { self: [{ tagged: 'midinette' }] } },
          { trigger: 'hit', state: { squad: { in_squad: { unit: 106, tagged: 'balance_seeker' } } } }
        ],
        target: { kind: 'enemy' },
        details: { target: { defense_penetration: { base: { milliPercentage: -10000 }, per_lv_up: { milliPercentage: -1000 }, term: { for_rounds: 2 } } } }
      }, {
        conditions: [
          { trigger: 'hit', state: { self: [{ tagged: 'trottin' }] } },
          { trigger: 'hit', state: { squad: { in_squad: { unit: 106, tagged: 'secretive_research' } } } }
        ],
        target: { kind: 'enemy' },
        details: { target: { range_down: { value: { 1: 1, 10: 2 }, term: { for_rounds: 2 } } } }
      }, {
        conditions: [{ trigger: 'critical' }],
        target: { kind: 'enemy' },
        details: {
          target: {
            fixed_damage_over_time: { base: { value: 500 }, per_lv_up: { value: 50 }, term: { for_rounds: 2 } },
            def_down: { base: { milliPercentage: 20000 }, per_lv_up: { milliPercentage: 2500 }, term: { for_rounds: 2 }, max_stack: 1 }
          }
        }
      }]
    }, {
    ...
    passive: [{
      ...
      effects: [{
        conditions: [{ trigger: 'start_round', state: { self: [{ grid: 'front_line' }] } }],
        details: { self: { status_resist_up: { tag: 'cousette', base: { milliPercentage: 30000 }, per_lv_up: { milliPercentage: 3000 }, term: { for_rounds: 1 } } } }
      }, {
        conditions: [{ trigger: 'start_round', state: { self: [{ grid: 'mid_line' }] } }],
        details: { self: { spd_up: { tag: 'midinette', base: { milliPercentage: 15000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 1 } } } }
      }, {
        conditions: [{ trigger: 'start_round', state: { self: [{ grid: 'back_line' }] } }],
        details: {
          self: {
            acc_up: { tag: 'trottin', base: { milliPercentage: 50000 }, per_lv_up: { milliPercentage: 5000 }, term: { for_rounds: 1 } },
            range_up: { tag: 'trottin', value: { 1: 1, 10: 2 }, term: { for_rounds: 1 } }
          }
        }
      }, {
        conditions: [{ trigger: 'start_round', state: { enemy: { num_of_units: { equal: 1 }, unit: 'light' } } }],
        details: { self: { tag_stack: { tag: 'tailor_made_cutting_light', term: { for_rounds: 1 } } } }
      }, {
        conditions: [{ trigger: 'start_round', state: { enemy: { num_of_units: { equal: 1 }, unit: 'flying' } } }],
        details: { self: { tag_stack: { tag: 'tailor_made_cutting_flying', term: { for_rounds: 1 } } } }
      }, {
        conditions: [{ trigger: 'start_round', state: { enemy: { num_of_units: { equal: 1 }, unit: 'heavy' } } }],
        details: { self: { tag_stack: { tag: 'tailor_made_cutting_heavy', term: { for_rounds: 1 } } } }
      }]
    }, {
      area: 'self',
      effects: [{
        conditions: [{ trigger: 'start_round', state: { squad: { in_squad: 106 } } }],
        details: {
          self: {
            atk_up: { base: { milliPercentage: 10000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 1 } },
            acc_up: { base: { milliPercentage: 20000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 1 } },
      ...
      effects: [{
        conditions: [{ trigger: 'start_round' }],
        target: { kind: 'ally', conditions: ['pecs_designers'] },
        details: { target: { ignore_protect: { term: { for_rounds: 1 } } } }
      }, {
  ...
  104: {
    ...
    active: [{
      ...
      space: {
        ...
        effects: [{
          ...
          conditions: [{ trigger: 'critical' }],
          target: { kind: 'enemy' },
          details: { target: { damage_reduction_down: { base: { milliPercentage: 15000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 2 } } } }
        }]
      }
    }, {
      normal: {
        ...
        area: 'single',
        effects: [{
          details: { self: { merciless: { base: { milliPercentage: 25000 }, per_lv_up: { milliPercentage: 2500 }, term: 'immediate' } } }
        }, {
      ...
      space: {
        ...
        effects: [{
          ...
          conditions: [{ trigger: 'hit', state: { target: [{ affected: 'def_up' }] } }],
          target: { kind: 'enemy' },
          details: {
            target: {
              atk_down: { base: { milliPercentage: 10000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 2 } },
          ...
          conditions: [{ trigger: 'hit', state: { target: [{ not_affected: ['def_up'] }] } }],
          target: { kind: 'enemy' },
          details: {
            target: {
              atk_down: { base: { milliPercentage: 20000 }, per_lv_up: { milliPercentage: 2000 }, term: { for_rounds: 2 }, cannot_be_dispelled: true },
    ...
    passive: [{
      ...
      normal: {
        area: 'self',
        effects: [{
          conditions: [{ trigger: 'start_wave', state: { self: [{ equipped: 'space' }] } }],
          details: { self: { form_change: { form: 'space' } } }
        }, {
          conditions: [{ trigger: 'start_round' }],
          details: {
            self: {
        ...
        effects: [{
          ...
          details: {
            self: {
              ...
              def_down: { milliPercentage: 10000, term: { for_rounds: 1 }, cannot_be_dispelled: true },
            }
          }
        }, {
          conditions: [{ trigger: 'start_wave' }],
    ...
    passive: [{
      ...
      effects: [{
        ...
        details: {
          target: {
            spd_up: { base: { milliPercentage: 2000 }, per_lv_up: { milliPercentage: 500 }, term: { for_rounds: 1 } },
            fire_resist_up: { base: { milliPercentage: 15000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 1 } },
            ice_resist_up: { base: { milliPercentage: 15000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 1 } },
            electric_resist_up: { base: { milliPercentage: 15000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 1 } },
            status_resist_up: { base: { milliPercentage: 30000 }, per_lv_up: { milliPercentage: 2000 }, term: { for_rounds: 1 } }
          }
        }
      }, {
        ...
        details: {
          target: {
            ...
            ice_resist_up: { base: { milliPercentage: 30000 }, per_lv_up: { milliPercentage: 2000 }, term: { for_rounds: 1 } },
            electric_resist_up: { base: { milliPercentage: 30000 }, per_lv_up: { milliPercentage: 2000 }, term: { for_rounds: 1 } },
            status_resist_up: { base: { milliPercentage: 15000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 1 } }
          }
        }
      }, {
      ...
      effects: [{
        conditions: [{ trigger: 'start_round' }],
        details: { self: { damage_reduction_up: { base: { milliPercentage: 20000 }, per_lv_up: { milliPercentage: 2500 }, term: { for_rounds: 1 } } } }
      }, {
      ...
      effects: [{
        ...
        details: {
          target: {
            ice_resist_down: { tag: 'wet', base: { milliPercentage: 50000 }, per_lv_up: { milliPercentage: 2500 }, term: { for_rounds: 2 }, max_stack: 1 },
            electric_resist_down: { tag: 'wet', base: { milliPercentage: 50000 }, per_lv_up: { milliPercentage: 2500 }, term: { for_rounds: 2 }, max_stack: 1 },
            fire_resist_up: { tag: 'wet', base: { milliPercentage: 50000 }, per_lv_up: { milliPercentage: 2500 }, term: { for_rounds: 2 }, max_stack: 1 }
          }
        }
      }]
    }]
  ...
  120: {
    ...
    active: [{
      ...
      area: 'single',
      effects: [{
        conditions: [{ state: { self: [{ not_tagged: 'four_ounces_deflects_thousand_pounds' }] } }],
        details: { self: { defense_penetration: { base: { milliPercentage: 30000 }, per_lv_up: { milliPercentage: 4000 }, term: 'immediate' } } }
      }, {
        conditions: [{ state: { target: [{ grid: 'front_line' }] } }],
        target: { kind: 'enemy' },
        ...
        conditions: [{ state: { self: [{ tagged: 'four_ounces_deflects_thousand_pounds' }] } }],
        details: { self: { ignore_barrier_dr: { term: 'immediate' } } }
      }]
    }],
    passive: [{
      ...
      effects: [{
        ...
        details: {
          self: {
            range_up: { value: { 1: 1, 10: 2 }, term: { for_rounds: 1 } },
            spd_up: { base: { milliPercentage: 10000 }, per_lv_up: { milliPercentage: 500 }, term: { for_rounds: 1 } },
      ...
      effects: [{
        ...
        details: {
          self: {
            ignore_def: { tag: 'four_ounces_deflects_thousand_pounds', term: { for_rounds: 1 }, cannot_be_dispelled: true },
  ...
  121: {
    ...
    active: [{
      ...
      effects: [{
        ...
        conditions: [{ trigger: 'hit', state: { target: [{ tagged_affected: { tag: 'sanctuary_proclamation', effect: 'damage_taken_increased' } }] } }],
        target: { kind: 'enemy' },
        details: { target: { buff_removal: { effect: 'damage_reduction_up', term: 'immediate' } } }
      }]
    }, {
      ...
      area: 'self',
      effects: [{
        conditions: [{ state: { self: [{ not_tagged: 'patron_saint' }] } }],
        details: {
          self: {
    ...
    passive: [{
      ...
      effects: [{
        conditions: [{ trigger: 'start_wave' }],
        scale_factor: { per_units: { type: 'enemy', variation: 'proportional' } },
        details: { self: { def_up: { base: { milliPercentage: 10000 }, per_lv_up: { milliPercentage: 500 }, term: 'infinite', cannot_be_dispelled: true } } }
      }, {
        conditions: [{ trigger: 'start_round' }],
        scale_factor: { per_units: { type: 'squad' } },
        target: { kind: 'enemy' },
        details: { target: { damage_taken_increased: { tag: 'sanctuary_proclamation', base: { milliPercentage: 1000 }, per_lv_up: { milliPercentage: 100 }, term: { for_rounds: 1 }, times: 1, cannot_be_dispelled: true } } }
      }]
    }, {
      area: 'fixed_all',
      effects: [{
        conditions: [{ trigger: 'start_round' }],
        details: { self: { status_resist_up: { base: { milliPercentage: 30000 }, per_lv_up: { milliPercentage: 3000 }, term: { for_rounds: 1 } } } }
      }, {
        conditions: [{ trigger: 'start_round', state: { self: [{ equipped: 'super_alloy_plate_armor' }] } }],
        ...
        conditions: [{ trigger: 'idle' }],
        scale_factor: { per_units: { type: 'squad', except: 'self' } },
        details: { self: { fixed_damage_over_time: { base: { value: 20 }, per_lv_up: { value: 3 } } } }
      }]
    }, {
      area: 'fixed_all',
      effects: [{
        ...
        details: {
          self: {
            row_protect: { tag: 'patron_saint', term: { for_rounds: 1 } },
            column_protect: { tag: 'patron_saint', term: { for_rounds: 1 } },
            damage_reduction_up: { tag: 'patron_saint', base: { milliPercentage: 25000 }, per_lv_up: { milliPercentage: 3000 }, term: { for_rounds: 1 } }
          }
        }
      }, {
        conditions: [{ trigger: 'use_active_2' }],
  ...
  122: {
    ...
    active: [{
      ...
      area: 'single',
      effects: [{
        conditions: [{ trigger: 'hit', state: { self: [{ not_tagged: 'brute_force_attack' }] } }],
        target: { kind: 'enemy' },
        details: {
          target: {
        ...
        conditions: [{ trigger: 'hit', state: { self: [{ tagged: 'brute_force_attack' }] } }],
        target: { kind: 'enemy' },
        details: {
          target: {
            fixed_damage_over_time: { tag: 'overloaded', base: { value: 160 }, per_lv_up: { value: 80 }, term: { for_rounds: 2 } },
            acc_down: { tag: 'overloaded', base: { milliPercentage: 60000 }, per_lv_up: { milliPercentage: 3000 }, term: { for_rounds: 2 } },
            damage_taken_increased: { tag: 'overloaded', base: { milliPercentage: 30000 }, per_lv_up: { milliPercentage: 1500 }, term: { for_rounds: 2 } },
            status_resist_down: { tag: 'overloaded', base: { milliPercentage: 20000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 2 }, cannot_be_dispelled: true }
          }
        }
      }]
    }, {
      ...
      effects: [{
        ...
        conditions: [{ trigger: 'hit', state: { self: [{ not_tagged: 'brute_force_attack' }], target: [{ tagged: 'overloaded' }] } }],
        target: { kind: 'enemy' },
        details: { target: { stunned: { rate: { milliPercentage: 100000 } } } }
      }, {
        conditions: [{ trigger: 'critical', state: { self: [{ tagged: 'warm_up' }] } }],
        target: { kind: 'enemy' },
        details: {
          self: { minimize_damage: { term: 'infinite', times: 1 } },
        ...
        conditions: [{ trigger: 'hit', state: { self: [{ tagged: 'brute_force_attack' }], target: [{ tagged: 'overloaded' }] } }],
        target: { kind: 'enemy' },
        details: { self: { additional_damage: { base: { milliPercentage: 50000 }, per_lv_up: { milliPercentage: 5000 }, term: 'immediate' } } }
      }]
    }],
    passive: [{
      area: 'self',
      ...
      effects: [{
        ...
        details: {
          target: {
            atk_up: { base: { milliPercentage: 10000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 2 }, max_stack: 2 },
            def_up: { base: { milliPercentage: 10000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 2 }, max_stack: 2 },
            acc_up: { base: { milliPercentage: 10000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 2 }, max_stack: 2 }
          }
        }
      }, {
        conditions: [{ trigger: 'hit', state: { target: [{ not_affected: ['status_resist_up'] }, { affected: 'status_resist_down' }] } }],
        target: { kind: 'enemy' },
  ...
  133: {
    ...
    passive: [{
      ...
      effects: [{
        ...
        conditions: [{ trigger: 'start_round' }],
        target: { kind: 'ally_except_self', conditions: ['elven'] },
        details: {
          target: {
            atk_up: { base: { milliPercentage: 15000 }, per_lv_up: { milliPercentage: 750 }, term: { for_rounds: 1 } },
            cri_up: { base: { milliPercentage: 10000 }, per_lv_up: { milliPercentage: 500 }, term: { for_rounds: 1 } },
  ...
  137: {
    ...
    active: [{
      ...
      effects: [{
        ...
        details: {
          target: {
            def_down: { base: { milliPercentage: 30000 }, per_lv_up: { milliPercentage: 5000 }, term: { for_rounds: 2 } },
            damage_taken_increased: { base: { milliPercentage: 30000 }, per_lv_up: { milliPercentage: 1500 }, term: { for_rounds: 2 } }
          }
        }
      }, {
        conditions: [{ trigger: 'critical' }],
        target: { kind: 'enemy' },
        details: { target: { buff_removal: { effects: ['def_up', 'damage_reduction_up'], term: 'immediate' } } }
      }]
    }],
    passive: [{
      area: 'self',
      effects: [{
        ...
        details: {
          self: {
            atk_up: { base: { milliPercentage: 15000 }, per_lv_up: { milliPercentage: 1500 }, term: { for_rounds: 1 } },
            cri_up: { base: { milliPercentage: 10000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 1 } },
            defense_penetration: { base: { milliPercentage: 20000 }, per_lv_up: { milliPercentage: 5000 }, term: { for_rounds: 1 } },
            damage_reduction_up: { base: { milliPercentage: 25000 }, per_lv_up: { milliPercentage: 3000 }, term: { for_rounds: 1 } },
            status_resist_up: { base: { milliPercentage: 10000 }, per_lv_up: { milliPercentage: 5000 }, term: { for_rounds: 1 } }
          }
        }
      }]
    }, {
      ...
      effects: [{
        ...
        conditions: [{ trigger: 'start_round', state: { target: [{ grid: 'back_line' }] } }],
        target: { kind: 'ally' },
        details: { target: { defense_penetration: { base: { milliPercentage: 20000 }, per_lv_up: { milliPercentage: 2000 }, term: { for_rounds: 1 } } } }
      }, {
        conditions: [{ trigger: 'start_round' }],
        target: { kind: 'ally' },
        details: { target: { prevents_effect: { effect: 'defense_penetration_down', term: 'infinite' } } }
      }]
    }, {
      area: 'self',
      effects: [{
        ...
        conditions: [{ trigger: 'start_round' }],
        scale_factor: { per_units: { type: 'squad', unit: 'attacker' } },
        details: { self: { cri_up: { base: { milliPercentage: 15000 }, per_lv_up: { milliPercentage: 1500 }, term: { for_rounds: 1 } } } }
      }, {
        conditions: [{ trigger: 'start_round' }],
        scale_factor: { per_units: { type: 'squad', unit: 'supporter' } },
  ...
  169: {
    ...
    passive: [{
      ...
      effects: [{
        ...
        conditions: [{ trigger: 'start_wave', state: { squad: { num_of_units: { less_than: 'enemy' } } } }],
        details: { self: { battle_continuation: { base: { milliPercentage: 30000 }, per_lv_up: { milliPercentage: 4000 }, term: 'infinite', cannot_be_dispelled: true } } }
      }]
    }, {
      area: 'fixed_all',
  ...
  176: {
    ...
    active: [{
      ...
      area: 'fixed_all',
      effects: [{
        target: { kind: 'ally', conditions: ['light', 'elven'] },
        details: {
          target: {
            all_debuff_removal: {},
        ...
        conditions: [{ state: { target: [{ tagged: 'alternate_power_source' }] } }],
        target: { kind: 'ally', conditions: [212] },
        details: {
          target: {
            ap_up: { base: { microValue: 200000 }, per_lv_up: { microValue: 200000 }, term: 'immediate' },
            atk_up: { base: { milliPercentage: 17000 }, per_lv_up: { milliPercentage: 2000 }, term: { for_rounds: 3 } },
    ...
    passive: [{
      ...
      effects: [{
        ...
        conditions: [{ trigger: 'start_round' }],
        scale_factor: { per_units: { type: 'squad', unit: 'elven', except: 'self' } },
        details: { self: { spd_up: { base: { milliPercentage: 500 }, per_lv_up: { milliPercentage: 500 }, term: { for_rounds: 1 } } } }
      }]
    }, {
      area: 'fixed_all',
      ...
      effects: [{
        ...
        target: { kind: 'ally' },
        details: { target: { damage_reduction_up: { tag: 'motherhood', base: { milliPercentage: 23000 }, per_lv_up: { milliPercentage: 3000 }, term: { for_rounds: 1 } } } }
      }]
    }]
  },
  177: {
  ...
  212: {
    ...
    active: [{
      ...
      area: 'single',
      effects: [{
        details: { self: { enmity: { base: { milliPercentage: 20000 }, per_lv_up: { milliPercentage: 5000 }, term: 'immediate' } } }
      }, {
        conditions: [{ trigger: 'hit' }],
        target: { kind: 'enemy' },
        details: { target: { def_down: { base: { milliPercentage: 20000 }, per_lv_up: { milliPercentage: 2000 }, term: { for_rounds: 2 } } } }
      ...
      effects: [{
        ...
        details: {
          target: {
            effect_removal: { effect: 'area_damage_dispersion_up', term: 'immediate' },
            damage_taken_increased: { base: { milliPercentage: 10000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 2 } }
          }
        }
      }, {
        conditions: [{ trigger: 'hit', state: { squad: { in_squad: 238 } } }],
        details: { self: { cooperative_attack: { unit: 238, active: 2, term: 'immediate' } } }
      }]
    }],
    passive: [{
      area: 'self',
      effects: [{
        ...
        details: {
          self: {
            additional_damage: { base: { milliPercentage: 30000 }, per_lv_up: { milliPercentage: 5000 }, term: 'immediate' },
            fixed_damage: { milliPercentage: 20000, term: 'immediate' }
          },
      ...
      effects: [{
        conditions: [{ trigger: 'start_wave' }],
        details: { self: { battle_continuation: { base: { milliPercentage: 30000 }, per_lv_up: { milliPercentage: 5000 }, term: 'infinite', times: 1, cannot_be_dispelled: true }  } }
      }, {
        conditions: [{ trigger: 'kill' }],
        details: { self: { battle_continuation: { base: { milliPercentage: 30000 }, per_lv_up: { milliPercentage: 5000 }, term: 'infinite', times: 1, max_stack: 1, cannot_be_dispelled: true }  } }
      }, {
        conditions: [{ trigger: 'be_hit' }],
        details: { self: { atk_value_up: { base: { milliValue: 50000 }, per_lv_up: { milliValue: 5000 }, term: { for_rounds: 3 } }  } }
      }]
    }, {
      area: 'fixed_all',
      effects: [{
        conditions: [{ trigger: 'start_round', state: { target: [{ tagged: 'motherhood' }] } }],
        target: { kind: 'ally' },
        details: {
          target: {
            ignore_barrier_dr: { term: { for_rounds: 1 } },
        ...
        conditions: [{ trigger: 'start_wave' }],
        scale_factor: { per_units: { type: 'squad', unit: 'elven' } },
        details: { self: { ap_up: { base: { microValue: 100000 }, per_lv_up: { microValue: 50000 }, term: 'immediate' } } }
      }, {
        conditions: [{ trigger: 'be_killed' }],
        target: { kind: 'ally' },
  ...
  228: {
    ...
    passive: [{
      ...
      effects: [{
        ...
        conditions: [{ trigger: 'start_round', round: { at: 2 }, state: { self: [{ not_equipped: ['boiling_vessel'] }] } }],
  ...
  235: {
    ...
    active: [{
      ...
      effects: [{
        ...
        details: {
          target: {
            acc_down: { base: { milliPercentage: 25000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 2 } },
            immovable: { term: { for_rounds: 2 }, max_stack: 1 }
          }
        }
      }]
      ...
      effects: [{
        ...
        conditions: [{ trigger: 'hit' }],
        target: { kind: 'enemy' },
        details: { target: { electric_resist_down: { base: { milliPercentage: 15000 }, per_lv_up: { milliPercentage: 1500 }, term: { for_rounds: 2 } } } }
      }, {
        conditions: [{ trigger: 'hit', state: { target: [{ affected: 'immovable' }] } }],
        target: { kind: 'enemy' },
        details: { self: { additional_damage: { base: { milliPercentage: 15000 }, per_lv_up: { milliPercentage: 1500 }, term: 'immediate' } } }
    ...
    passive: [{
      ...
      effects: [{
        ...
        details: {
          self: {
            eva_up: { base: { milliPercentage: 25000 }, per_lv_up: { milliPercentage: 2500 }, term: { for_rounds: 1 } },
            status_resist_up: { base: { milliPercentage: 25000 }, per_lv_up: { milliPercentage: 2500 }, term: { for_rounds: 1 } },
            merciless: { base: { milliPercentage: 35000 }, per_lv_up: { milliPercentage: 2000 }, term: { for_rounds: 1 } }
          }
        }
      }, {
        conditions: [{ trigger: 'be_attacked' }],
        details: { self: { counterattack: { base: { milliPercentage: 90000 }, per_lv_up: { milliPercentage: 5000 }, term: 'immediate' } } }
      }, {
        conditions: [{ trigger: 'counter' }],
        details: {
          self: {
            eva_up: { base: { milliPercentage: 25000 }, per_lv_up: { milliPercentage: 2500 }, term: { for_rounds: 2 }, max_stack: 3 },
            status_resist_up: { base: { milliPercentage: 25000 }, per_lv_up: { milliPercentage: 2500 }, term: { for_rounds: 2 }, max_stack: 3 }
          }
        }
      }]
    }, {
      ...
      effects: [{
        conditions: [{ trigger: 'start_round' }],
        target: { kind: 'ally', conditions: ['flying', 'orbital_watcher'] },
        details: { target: { follow_up_attack: { term: { for_rounds: 1 } } } }
      }, {
        conditions: [{ trigger: 're_attack' }, { trigger: 'follow_up_attack' }],
        target: { kind: 'ally', conditions: ['flying', 'orbital_watcher'] },
        details: { target: { atk_up: { base: { milliPercentage: 5000 }, per_lv_up: { milliPercentage: 500 }, term: { for_rounds: 3 }, max_stack: 10 } } }
      }, {
        conditions: [{ trigger: 'start_round', state: { self: [{ affected: 'target_protect' }] } }],
        details: { self: { damage_multiplier_up: { base: { milliPercentage: 20000 }, per_lv_up: { milliPercentage: 2000 }, term: { for_rounds: 1 } } } }
      }]
    }, {
      area: 'fixed_all',
      effects: [{
        conditions: [{ trigger: 'start_round' }],
        target: { kind: 'ally', conditions: ['flying', 'orbital_watcher'] },
        details: { target: { light_type_damage_up: { base: { milliPercentage: 15000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 1 } } } }
      }, {
        conditions: [{ trigger: 'start_round', state: { squad: { num_of_units: { unit: 'flying', less_or_equal: 'enemy' } } } }],
        scale_factor: { per_units: { type: 'squad', unit: 'flying' } },
        target: { kind: 'enemy' },
        details: { target: { electric_resist_down: { base: { milliPercentage: 5000 }, per_lv_up: { milliPercentage: 500 }, term: { for_rounds: 1 } } } }
      }, {
        conditions: [{ trigger: 'start_round', state: { squad: { num_of_units: { unit: 'flying', greater_than: 'enemy' } } } }],
        scale_factor: { per_units: { type: 'squad', unit: 'flying' } },
        target: { kind: 'enemy' },
        details: { target: { electric_resist_down: { base: { milliPercentage: 7500 }, per_lv_up: { milliPercentage: 750 }, term: { for_rounds: 1 } } } }
      }]
    }]
  },
  236: {
  ...
  238: {
    ...
    passive: [{
      ...
      effects: [{
        conditions: [{ trigger: 'start_round' }],
        target: { kind: 'ally' },
        details: { target: { acc_up: { tag: 'motherhood', base: { milliPercentage: 15000 }, per_lv_up: { milliPercentage: 1500 }, term: { for_rounds: 1 } } } }
      }, {
        conditions: [{ trigger: 'start_round' }],
        target: { kind: 'ally', conditions: ['supporter', 'defender'] },
        details: { target: { row_protect: { tag: 'motherhood', term: { for_rounds: 1 } } } }
      }]
    }]
  },
  239: {
  ...
  301: {
    ...
    active: [{
      ...
      area: 'single',
      effects: [{
        details: { self: { defense_penetration: { base: { milliPercentage: 30000 }, per_lv_up: { milliPercentage: 5000 }, term: 'immediate' } } }
      }, {
        conditions: [{ trigger: 'hit' }],
        target: { kind: 'enemy' },
        details: {
      ...
      effects: [{
        ...
        conditions: [{ trigger: 'critical' }],
        target: { kind: 'enemy' },
        details: { target: { damage_multiplier_down: { base: { milliPercentage: 30000 }, per_lv_up: { milliPercentage: 5000 }, term: { for_rounds: 1 } } } }
      }]
    }],
    passive: [{
      area: 'self',
      ...
      area: 'self',
      effects: [{
        conditions: [{ trigger: 'start_round', state: { self: [{ not_tagged: 'basaro_sealed' }] } }],
        details: { self: { re_attack: { term: { for_rounds: 1 } } } }
      }, {
        conditions: [{ trigger: 'revive', state: { self: [{ not_affected: ['battle_continuation'], not_tagged: 'basaro_sealed' }] } }],
        details: {
          self: {
            battle_continuation: { base: { milliPercentage: 30000 }, per_lv_up: { milliPercentage: 5000 }, term: 'infinite', times: 1, cannot_be_dispelled: true },
            buff_removal: { effect: 're_attack', term: 'immediate' },
            tag_stack: { tag: 'basaro_sealed', term: { for_rounds: 3 }, cannot_be_dispelled: true }
          }
        }
      }]
    }, {
      ...
      effects: [{
        ...
        conditions: [{ trigger: 'enemy_killed' }],
        details: { self: { spd_up: { tag: 'kyu_kyu_nyo_ritsu_ryo', base: { milliPercentage: 5000 }, per_lv_up: { milliPercentage: 1000 }, term: { for_rounds: 3 }, max_stack: 4 } } }
      }, {
        conditions: [{ trigger: 'start_round' }],
