export const Effect = {
  ...
  MinimumFireResistUp: 'minimum_fire_resist_up',
  MinimumIceResistUp: 'minimum_ice_resist_up',
  MinimumElectricResistUp: 'minimum_electric_resist_up',
  FixedDamage: 'fixed_damage',
  FixedFireDamage: 'fixed_fire_damage',
  ...
  DefensePenetrationDown: 'defense_penetration_down',
  DamageTakenIncreased: 'damage_taken_increased',
  DamageReductionUp: 'damage_reduction_up',
  DamageReductionDown: 'damage_reduction_down',
  ...
  AreaDamageDispersionUp: 'area_damage_dispersion_up',
  AreaDamageDispersionDown: 'area_damage_dispersion_down',
  Barrier: 'barrier',
