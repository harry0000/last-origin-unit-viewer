...
export function buildUnitSkill(unit: UnitBasicInfo): UnitSkill {
  if (hasFormChangeUnitNumber(unit)) {
    ...
    case FormChangeUnits.Nashorn:
      return new NashornUnitSkill(unit);
    ...
    case FormChangeUnits.Olivia:
      return new OliviaUnitSkill(unit);
    case FormChangeUnits.Spartoia:
      return new SpartoiaUnitSkill(unit);
...
class NashornUnitSkill extends FormChangeUnitSkill<typeof FormChangeUnits.Nashorn> {

  constructor(
    unit: FormChangeUnitBasicInfo<typeof FormChangeUnits.Nashorn>,
    skillLv?: UnitSkillLvValue,
    form?: UnitFormValue<typeof FormChangeUnits.Nashorn>
  ) {
    super(unit, skillLv, form);
  }

  protected updateSkillLvValue(lv: UnitSkillLvValue): UnitSkill {
    return new NashornUnitSkill(this.formChangeUnit, lv, this.form);
  }

  protected updateUnitFormValue(form: UnitFormValue<typeof FormChangeUnits.Nashorn>): FormChangeUnitSkill<typeof FormChangeUnits.Nashorn> {
    return new NashornUnitSkill(this.formChangeUnit, this.skillLv, form);
  }
...
class OliviaUnitSkill extends FormChangeUnitSkill<typeof FormChangeUnits.Olivia> {

  constructor(
    unit: FormChangeUnitBasicInfo<typeof FormChangeUnits.Olivia>,
    skillLv?: UnitSkillLvValue,
    form?: UnitFormValue<typeof FormChangeUnits.Olivia>
  ) {
    super(unit, skillLv, form);
  }

  protected updateSkillLvValue(lv: UnitSkillLvValue): UnitSkill {
    return new OliviaUnitSkill(this.formChangeUnit, lv, this.form);
  }

  protected updateUnitFormValue(form: UnitFormValue<typeof FormChangeUnits.Olivia>): FormChangeUnitSkill<typeof FormChangeUnits.Olivia> {
    return new OliviaUnitSkill(this.formChangeUnit, this.skillLv, form);
  }
...
class SpartoiaUnitSkill extends FormChangeUnitSkill<typeof FormChangeUnits.Spartoia> {

  constructor(
    unit: FormChangeUnitBasicInfo<typeof FormChangeUnits.Spartoia>,
    skillLv?: UnitSkillLvValue,
    form?: UnitFormValue<typeof FormChangeUnits.Spartoia>
  ) {
    super(unit, skillLv, form);
  }

  protected updateSkillLvValue(lv: UnitSkillLvValue): UnitSkill {
    return new SpartoiaUnitSkill(this.formChangeUnit, lv, this.form);
  }

  protected updateUnitFormValue(form: UnitFormValue<typeof FormChangeUnits.Spartoia>): FormChangeUnitSkill<typeof FormChangeUnits.Spartoia> {
    return new SpartoiaUnitSkill(this.formChangeUnit, this.skillLv, form);
  }
